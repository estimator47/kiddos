...
<div class="wrapper">
    ...
    <header class="main-header">
        <a href="" class="logo">
             <span class="logo-mini"><b>JA</b></span>
            <span class="logo-lg">Jajji Akademiklar</span>
        </a>
                              ...
                              <ul class="menu">
                                 <li>
                                    <div class="add_funct_top">
                                      ...
                                      document.getElementById('logout-form').submit();"><div class="dropdown-menu-div">{{ __('message.Logout') }}</div></a>
     ...
     <aside class="main-sidebar">
        <section class="sidebar">
            <ul class="sidebar-menu">
                ...
                <li>
                    <a href="{{url('/')}}">
                        <i class="fa fa-folder-o"></i> <span>{{ __('message.main') }}</span>
                    </a>
                </li>
                <li class="header" style="font-size: 15px;">Admin</li>
                <li>
                    <a href="{{url('/bogcha')}}">
                        <i class="fa fa-folder-o"></i> <span>{{ __('message.news') }}</span>
                    </a>
                </li>
                <li>
                    <a href="{{url('/tarbiyachi')}}">
                        <i class="fa fa-folder-o"></i> <span>{{ __('message.staff') }}</span>
                    </a>
                </li>
                <li>
                    <a href="{{url('/rasm')}}">
                        <i class="fa fa-folder-o"></i> <span>{{ __('message.gallery') }}</span>
                    </a>
                </li>
                <li>
                    <a href="{{route('xabar')}}">
                        <i class="fa fa-folder-o"></i> <span>{{ __('message.message') }}</span>
                    </a>
                </li>
            </ul>
        </section>
